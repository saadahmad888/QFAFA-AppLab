          ...
          (b.boot = function (e, t) {
            ...
            if (
              ...
              var r = new XMLHttpRequest(),
                a = b.getPlatformUrl();
              a += "/p/boot/";
              var s = o.stringify({ w: i.join(","), page: b.getPage() });
              r.open("get", a + "?" + s),
                (r.withCredentials = !0),
                (r.onload = function () {
      ...
      c = function () {
        ...
        (e.initialize = function () {
          ...
          (e.register = function (n, i) {
            ...
            (t[n] = new r(new i())), e.initWidgetsFromBuffer(n);
            var o = s(n);
            o && ((t[o] = new r(new i())), e.initWidgetsFromBuffer(o));
          }),
          (e.app = function (e) {
            return t[e];
          }),
          (e.initWidget = function (t, i) {
            ...
            if (o) {
              ...
              a.push(t), o.initWidget(t, i), e.sendExtensionPostMessage(t, i);
          ...
          (e.sendExtensionPostMessage = function (e, t) {
            ...
            n.postMessage(
              { method: "postMessagePlatformWidget", data: i },
              "*"
            );
          }),
          e.initialize();
      ...
      if (null != n) {
        ...
        try {
          if (((r = (n = n.call(e)).next), 0 === t)) {
            ...
            for (
              ;
              !(l = (i = r.call(n)).done) && (s.push(i.value), s.length !== t);
              l = !0
            );
        } catch (e) {
          (c = !0), (o = e);
